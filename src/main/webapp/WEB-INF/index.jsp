				...
				<div class="well span5 center login-box">
					...
					<fieldset>
							<div class="input-prepend" title="登录账号" data-rel="tooltip">
								...
								<input class="input-large span10" id="loginCode" name="loginCode" type="text" value="${user.loginCode }" onkeydown="javascript:if(event.keyCode==13) document.getElementById('loginBtn').click();"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="登录密码" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span>
								<input class="input-large span10" id="password" name="password" type="password" onkeydown="javascript:if(event.keyCode==13) document.getElementById('loginBtn').click();"/>
							</div>
							<div class="clearfix"></div>
							
							<!-- 验证码 -->
							<div class="input-prepend" title="验证码" data-rel="tooltip">
								<input class="input-large" id="yanzhengma" name="yanzhengma" type="text" onkeydown="javascript:if(event.keyCode==13) document.getElementById('loginBtn').click();" style="width: 100px;"/>
								<input type="button" id="code" style="width: 80px;height: 30px; background-image: url('../statics/img/761658199044341639.jpg');border:none;font-size:18px; color:#00f; font-weight: bold; letter-spacing: 4px;"/>
							</div>
