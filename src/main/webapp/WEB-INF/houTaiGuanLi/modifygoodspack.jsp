...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/goodspack/updategoodspack">修改商品套餐</a></li>
	</ul>
</div>
			...
			<legend>修改商品套餐</legend>
                 <form action="/goodspack/savemodifygoodspackl" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsPackFunc();">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<ul class="aboutproductsList">
						  	<li><iframe id="goodsListFrame" class="goodsListFrame" src="/goodspack/goodslist"></iframe></li>
						  	<li id="selectgoodslist">
						  		<c:if test="${goodsList != null}">
					 				<c:forEach items="${goodsList}" var="goods">
					 				<div id="selectdiv">
					 				<label class="goodsname">${goods.goodsName}</label>
									<label class="goodscount"><input class="finalresult" goodsid="${goods.id}" rprice="${goods.realPrice}" type="text" value="${goods.goodsNum}"/></label>
					  	...
					  	<input id="goodsJson" type="hidden" name="m_listGoods"/>
					  </div>
					</div>
