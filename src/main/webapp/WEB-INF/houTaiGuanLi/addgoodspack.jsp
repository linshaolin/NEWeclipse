...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/goodspack/addgoodspack">添加商品套餐</a></li>
	</ul>
</div>
			...
			<legend>添加商品套餐</legend>
                 <form action="/goodspack/saveaddgoodspack" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<ul class="aboutproductsList">
					  	...
					  	<input id="goodsJson" type="hidden" name="a_listGoods"/>
					  </div>
					</div>
