...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/zidian/loginZiDianPage">数据字典管理</a></li>
	</ul>
</div>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <c:forEach items="${ziDianList}" var="zd">
						  	<li class="maintitle">
						  	
						  		<a class="typecodelist" typename="${zd.typeName}" typecode="${zd.typeCode}" dlid="${zd.id}">
						  		${zd.typeName}
						  		</a>
						  		<span class="mainset">
									<img class="modifyMainDic" dictypename="${zd.typeName}" dicid="${zd.id}" dictypecode="${zd.typeCode}" src="/statics/img/ico10.png"> <img class="delMainDic" dictypecode="${zd.typeCode}" dictypename="${zd.typeName}" src="/statics/img/linkdel.png">
								</span>
						  	</li>
						  </c:forEach>
						  <li class="addDicBtn">
			...
			<div class="modal hide fade" id="modifyDicModel">
					...
					<div class="modal-body">
						<p>
								<label>类型代码：</label>
								  <input id="modifytypeCode"  type="text" disabled="disabled">
								<label>类型名称：</label>
...
<script type="text/javascript" src="/statics/localjs/shujuzidian.js"></script>