...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/updateUser/userlist">用户管理</a></li>
	</ul>
</div>
...
<div class="box span12">
	...
	<div class="box-content">
		<form action="/updateUser/userlist" method="post" id="tianyefrom">
...
<div class="pagination pagination-centered">
  ...
  <ul id="tianye-zhong" style="float: left; padding-left: 150px;">
  	<c:choose>
  		...
  		<c:otherwise>
  		<li><a href="/updateUser/userlist?currentpage=1&s_referCode=${s_referCode }&s_loginCode=${s_loginCode}&s_roleId=${s_roleId}&s_isStart=${s_isStart}" title="首页">首页</a></li>
  		</c:otherwise>
  	</c:choose>
  	<c:if test="${page.prevPages != null }">
  		<c:forEach items="${page.prevPages}" var="num">
  		<li>
  		<a href="/updateUser/userlist?currentpage=${num }&s_referCode=${s_referCode }&s_loginCode=${s_loginCode}&s_roleId=${s_roleId}&s_isStart=${s_isStart}" title="${num }">
  		${num }</a>
  		</li>
  		</c:forEach>
  	</c:if>
  	...
  	<c:choose>
  		...
  		<c:otherwise>
  		<li><a href="/updateUser/userlist?currentpage=${page.zongYeShu }&s_referCode=${s_referCode }&s_loginCode=${s_loginCode}&s_roleId=${s_roleId}&s_isStart=${s_isStart}" title="尾页">尾页</a></li>
  		</c:otherwise>
  	</c:choose>
  	</c:if>
  	<c:if test="${page.zongYeShu == null }">
  ...
  <div id="tianye-you" style="float: left; padding-top: 3px; padding-left: 150px; font-size: 15px; color: blue;">
  	<form action="/updateUser/userlist" method="post">
  	...
  	<button type="submit" class="btn btn-primary"> GO </button>
  		...
  		<input type="hidden" value="${s_roleId}" name="s_roleId"/>
