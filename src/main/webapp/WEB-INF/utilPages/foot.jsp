<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">ty</a> 2017-11</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">kgc_ty</a></p>
		</footer>
	...
	<!-- add by hl 2015-12-23 multiple file ajaxfileupload plugin-->
	<script src="/statics/js/ajaxfileupload.js"></script>
	<!-- add by hl 2015-12-23 WdatePicker plugin-->
